...
public class PromotionServiceImpl implements PromotionService {
  ...
  @Override
  public Page<Promotion> adminGetListPromotion(String code, String name, String ispublic,
      String active, int page) {
    page--;
    if (page < 0) {
      page = 0;
    }

    Page<Promotion> rs = promotionRepository
        .adminGetListPromotion(code, name, ispublic, active, PageRequest.of(page, 15));
    ...
    if (req.isPublic() && req.isActive()) {
      ...
      if (alreadyPromotion != null) {
        throw new BadRequestException(
            "Chương trình khuyến mãi công khai \"" + alreadyPromotion.getCouponCode()
