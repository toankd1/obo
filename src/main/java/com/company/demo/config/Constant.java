...
public class Constant {
  ...
  public static ArrayList<Integer> SIZE_VN = new ArrayList<>(
      Arrays.asList(35, 36, 37, 38, 39, 40, 41, 42));
  ...
  public static ArrayList<Integer> LIST_ORDER_STATUS = new ArrayList<>(Arrays
