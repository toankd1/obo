...
@NamedNativeQuery(
    ...
    query =
        "SELECT orders.id, orders.total_price, orders.size size_vn, product.name product_name, product.product_images ->> \"$[0]\" as product_img\n"
            +
            "FROM orders\n" +
            "INNER JOIN product \n" +
...
@NamedNativeQuery(
    ...
    query =
        "SELECT orders.id, orders.total_price, orders.size size_vn, product.name product_name, orders.product_price,\n"
            +
