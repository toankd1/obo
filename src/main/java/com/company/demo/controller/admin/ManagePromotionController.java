...
public class ManagePromotionController {
  ...
  public String getPromotionManagePage(Model model,
    ...
    Page<Promotion> result = promotionService
        .adminGetListPromotion(code, name, ispublic, active, page);
  ...
  public ResponseEntity<?> updatePromotion(@Valid @RequestBody CreatePromotionReq req,
