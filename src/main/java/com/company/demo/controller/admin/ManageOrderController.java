...
public class ManageOrderController {
  ...
  public String getOrderDetailPage(Model model, @PathVariable long id) {
    ...
    if (order.getStatus() == ORDER_STATUS) {
      ...
      boolean sizeIsAvailable = productService
          .checkProductSizeAvailable(order.getProduct().getId(), order.getSize());
  ...
  public ResponseEntity<?> updateDetailOrder(@Valid @RequestBody UpdateDetailOrderReq req,
  ...
  public ResponseEntity<?> updateStatusOrder(@Valid @RequestBody UpdateStatusOrderReq req,
      @PathVariable long id) {
    User user = ((CustomUserDetails) SecurityContextHolder.getContext().getAuthentication()
        .getPrincipal()).getUser();
